                ...
                children: [
                  Container(
                    ...
                    child: ClipRRect(
                      ...
                      child: FadeInImage(
                          image: NetworkImage(
                              controller.specialist[1].imagPers.toString()),
                          placeholder:
                  ...
                  Column(
                    children: [
                      Text(controller.specialist[1].nombSani.toString(),
                          style: HelperTheme.titleBlackSM),
                      Text(
                        'specialist_psychologist'.tr,
            ...
            child: Column(
              children: [
                ...
                Container(
                    ...
                    child: Text(controller.specialist[1].perfSani.toString(),
